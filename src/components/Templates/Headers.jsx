    ...
    return (
        ...
        >
            ...
            <p className='text-zinc-100 mt-2'>
                ...
                <i class="ri-calendar-schedule-fill text-yellow-500"></i> {data.release_date || "comming soon..."}
                <i class="ml-4 ri-album-fill text-yellow-500"></i>{data.media_type.toUpperCase()}

            </p>

            <Link className='bg-[#6556CD] text-white p-3 rounded-md mt-3 '> Watch Trailer</Link>
